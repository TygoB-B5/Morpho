...
namespace Morpho
{
    public class HeavyPlayerController : PlayerController
    {
        private float DefaultScale = 7.0f;
        ...
        public HeavyPlayerController(Player player)
            : base(player)
        {
        }
        ...
        public override void StartController()
        {
            ...
            Parent.Sprite.color = Color.blue;
        }
